...
#### 调色节点[👀](https://www.bilibili.com/video/BV1Kv411i7uN)
```
1. 右键添加节点,新建节点
2. 双击可以断开节点连线
3. Alt+S:添加新的串行节点
4. 扣像:
    ...
    c. Shift+H单独展示
    d. 单独改变颜色
5. 并行节点:在输出时合并,在局部调色时使用(Alt+P)
6. 图层节点:右键可以调整混合模式//下面的层级在上面显示, 图层节点快捷键Alt+L
7. 右键可以增加输入接口
8. 特殊节点
    a. 外部节点(生成反向蒙版)
    b. RGB分离节点(降噪)
    c. 抠像:创建alpha输出,连接蓝色箭头
    d. 蒙版转场:先画好蒙版再使用alpha输出
9. 复制调色:
    a. 鼠标中键点击(先选中目标)
    b. 复制前一条/前两条:键盘加号/减号
    c. 抓静帧->右键应用调色
